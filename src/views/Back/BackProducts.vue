<template>
  <div>
    <div class="form-inline my-2">
      <input
        class="form-control form-control-sm w-50 mr-auto"
        type="text"
        placeholder="Search 請按 Enter"
      ...
      <table class="table table-sm text-nowrap table-hover">
        ...
        <tbody>
          <tr class="text-center" v-for="product in products" :key="product.id">
            ...
            <td v-if="product.is_enabled" class="text-success align-middle">
              已啟用
            </td>
        ...
        <ValidationObserver v-slot="{ invalid }">
          ...
          >
            ...
            <div class="modal-footer border-0">
              <button
                type="button"
                class="btn px-4 btn-outline-white"
                data-dismiss="modal"
              >
                取消
              </button>
